...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see ke.co.buku.service.impl.PasswordTokenManager#generateRecoveryToken(ke.co.buku.model.User)
     */
    @Override
    ...
    /**
     * @see ke.co.buku.service.impl.PasswordTokenManager#isRecoveryTokenValid(ke.co.buku.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see ke.co.buku.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
