...
<div class="col-sm-10">
    ...
    <form method="get" action="${ctx}/admin/status" id="searchForm" class="form-inline">
    ...
    <div id="actions" class="btn-group">
        <a class="btn btn-primary" href="<c:url value='/admin/statusform?method=Add&from=list'/>">
    ...
    <display:table name="statusList" cellspacing="0" cellpadding="0" requestURI=""
        ...
        <display:setProperty name="export.pdf.filename" value="Status List.pdf"/>
    </display:table>
</div>
