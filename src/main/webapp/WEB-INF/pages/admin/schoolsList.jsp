...
<div class="col-sm-10">
    <h2><fmt:message key="schoolsList.heading"/></h2>

    <form method="get" action="${ctx}/admin/schoolss" id="searchForm" class="form-inline">
    ...
    <display:table name="schoolsList" cellspacing="0" cellpadding="0" requestURI=""
       ...
       <display:column sortProperty="enabled" sortable="true" titleKey="school.enabled"
        ...
        <display:setProperty name="paging.banner.items_name"><fmt:message key="schoolList.schools"/></display:setProperty>

        <display:setProperty name="export.excel.filename" value="School List.xls"/>
        <display:setProperty name="export.csv.filename" value="School List.csv"/>
